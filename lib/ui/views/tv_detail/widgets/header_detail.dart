...
class HeaderDetail extends HookViewModelWidget<TVDetailViewModel> {
  const HeaderDetail({
    Key? key,
  }) : super(key: key);
              ...
              ClipRRect(
                ...
                child: CachedNetworkImage(
                  imageUrl: EndPoint.imdbImagePath
                      .replaceAll('%PATH%', tv.backdropPath ?? ''),
                  fit: BoxFit.cover,
                  width: 70,
                  height: 90,
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    buildGenres(context, tv.genres),
                    const SizedBox(height: 3),
                    Text(
                      FormatUtils.convertYear(tv.firstAirDate ?? ''),
                      style: Theme.of(context).textTheme.caption?.copyWith(
